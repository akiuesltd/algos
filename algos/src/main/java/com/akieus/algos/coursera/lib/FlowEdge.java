 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.FlowEdge.java
 *  Execution:    java com.akieus.algos.coursera.lib.FlowEdge
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.FlowEdge</tt> class represents a capacitated edge with a
...
public class FlowEdge {
    ...
    public FlowEdge(int v, int w, double capacity) {
        ...
        if (!(capacity >= 0.0)) throw new IllegalArgumentException("com.akieus.algos.coursera.lib.Edge capacity must be nonnegaitve");
        this.v         = v;
        this.w         = w;  
   ...
   /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.FlowEdge</tt> data type.
     */
