 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.FlowNetwork.java
 *  Execution:    java com.akieus.algos.coursera.lib.FlowNetwork V E
 *  Dependencies: com.akieus.algos.coursera.lib.Bag.java com.akieus.algos.coursera.lib.FlowEdge.java
 *
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.FlowNetwork</tt> class represents a capacitated network
...
public class FlowNetwork {
    ...
    public FlowNetwork(int V) {
        if (V < 0) throw new IllegalArgumentException("Number of vertices in a com.akieus.algos.coursera.lib.Graph must be nonnegative");
        this.V = V;
        this.E = 0;
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.FlowNetwork</tt> data type.
     */
