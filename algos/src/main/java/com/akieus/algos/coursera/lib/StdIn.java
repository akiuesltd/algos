 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.StdIn.java
 *  Execution:    java com.akieus.algos.coursera.lib.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.StdIn</tt> class provides static methods for reading strings
 ...
 *  mask. If the input begins with the optional byte-order mask, <tt>com.akieus.algos.coursera.lib.StdIn</tt>
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from com.akieus.algos.coursera.lib.In to com.akieus.algos.coursera.lib.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from com.akieus.algos.coursera.lib.In to com.akieus.algos.coursera.lib.StdIn. */
    ...
    /*** begin: section (2 of 2) of code duplicated from com.akieus.algos.coursera.lib.In to com.akieus.algos.coursera.lib.StdIn,
   ...
   /**
    ...
    public static char readChar() {
        ...
        assert ch.length() == 1 : "Internal (Std)com.akieus.algos.coursera.lib.In.readChar() error!"
   ...
   /**
    ...
    /*** end: section (2 of 2) of code duplicated from com.akieus.algos.coursera.lib.In to com.akieus.algos.coursera.lib.StdIn */
    
    
    // do this once when com.akieus.algos.coursera.lib.StdIn is initialized
    static {
        resync();
    }

    /**
     * If com.akieus.algos.coursera.lib.StdIn changes, use this to reinitialize the scanner.
     */
