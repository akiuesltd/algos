 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.Particle.java
 *  Execution:    none
 *  Dependencies: com.akieus.algos.coursera.lib.StdDraw.java
 *      
...
public class Particle {
    ...
    public double timeToHit(Particle b) {
        ...
        // if (drdr < sigma*sigma) com.akieus.algos.coursera.lib.StdOut.println("overlapping particles");
