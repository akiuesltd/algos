 ...
 * 
 *  % java -cp .:jama.jar com.akieus.algos.coursera.lib.PolynomialRegression
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.PolynomialRegression</tt> class performs a polynomial regression
...
public class PolynomialRegression {
    ...
    private final String variableName;  // degree of the polynomial regression
  ...
  /**
     ...
     * Use N as the name of the predictor variable.
