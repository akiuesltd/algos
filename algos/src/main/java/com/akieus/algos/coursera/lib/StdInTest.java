 ...
 * Test client for com.akieus.algos.coursera.lib.StdIn and com.akieus.algos.coursera.lib.In.
 **/
...
public class StdInTest {
    ...
    /**
     * com.akieus.algos.coursera.lib.In the two methods below, each Object[] of "steps" is a length-2
    ...
    public static void test(String input, Object[][] steps, boolean useStdIn) {
        ...
        if (useStdIn) {
            ...
            try { //call com.akieus.algos.coursera.lib.StdIn.resync();
    ...
    public static void main(String[] args) {
        ...
        if (testStdIn) 
            ...
            StdOut.println("Note: com.akieus.algos.coursera.lib.StdIn.resync is private, only com.akieus.algos.coursera.lib.In will be tested.");
