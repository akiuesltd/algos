 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.FordFulkerson.java
 *  Execution:    java com.akieus.algos.coursera.lib.FordFulkerson V E
 *  Dependencies: com.akieus.algos.coursera.lib.FlowNetwork.java com.akieus.algos.coursera.lib.FlowEdge.java com.akieus.algos.coursera.lib.Queue.java
 *
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.FordFulkerson</tt> class represents a data type for computing a
 ...
 *  and <em>E</em> is the number of edges. com.akieus.algos.coursera.lib.In practice, the algorithm will
 *  run much faster.
...
public class FordFulkerson {
        ...
        for (int v = 0; v < G.V(); v++) {
            for (FlowEdge e : G.adj(v)) {
                if (e.flow() < -FLOATING_POINT_EPSILON || e.flow() > e.capacity() + FLOATING_POINT_EPSILON) {
                    System.err.println("com.akieus.algos.coursera.lib.Edge does not satisfy capacity constraints: " + e);
                    return false;
                }
            }
        }
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.FordFulkerson</tt> data type.
     */
