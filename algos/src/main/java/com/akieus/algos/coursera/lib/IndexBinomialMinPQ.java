...
/**
 *  The com.akieus.algos.coursera.lib.IndexBinomialMinPQ class represents an indexed priority queue of generic keys.
 *  It supports the usual insert and delete-the-minimum operations,
 *  along with delete and change-the-key methods. 
 *  com.akieus.algos.coursera.lib.In order to let the client refer to keys on the priority queue,
...
public class IndexBinomialMinPQ<Key> implements Iterable<Integer> {
	...
	//Merges two Binomial Heaps together and returns the resulting Binomial com.akieus.algos.coursera.lib.Heap
