 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.In.java
 *  Execution:    java com.akieus.algos.coursera.lib.In   (basic test --- see source for required files)
 *  Dependencies: none
 *
...
public final class In {
   ...
   /**
     ...
     * @deprecated Clearer to use <tt>new com.akieus.algos.coursera.lib.In(filename)</tt>.{@link #readAllInts()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use <tt>new com.akieus.algos.coursera.lib.In(filename)</tt>.{@link #readAllDoubles()}
     */
   ...
   /**
     ...
     * @deprecated Clearer to use  <tt>new com.akieus.algos.coursera.lib.In(filename)</tt>.{@link #readAllStrings()}
     */
