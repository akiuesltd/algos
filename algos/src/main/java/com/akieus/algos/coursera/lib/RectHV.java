 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.RectHV.java
 *  Execution:    none
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.RectHV</tt> class is an immutable data type to encapsulate a
...
public final class RectHV {
    ...
    /**
     * Does this rectangle contain the point <tt>p</tt>?
     * @param  p the point
