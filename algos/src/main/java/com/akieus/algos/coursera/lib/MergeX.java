 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.MergeX.java
 *  Execution:    java com.akieus.algos.coursera.lib.MergeX < input.txt
 ...
 *
 *  % java com.akieus.algos.coursera.lib.MergeX < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *    
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *  
 *  % java com.akieus.algos.coursera.lib.MergeX < words3.txt
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.MergeX</tt> class provides static methods for sorting an
