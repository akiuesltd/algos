 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.SuffixArray.java
 *  Execution:    java com.akieus.algos.coursera.lib.SuffixArray < input.txt
 ...
 *
 *   % java com.akieus.algos.coursera.lib.SuffixArray < abra.txt
 ...
 *   11   2   2  11  "RACADABRA!"
 *
 *  See com.akieus.algos.coursera.lib.SuffixArrayX.java for an optimized version that uses 3-way
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.SuffixArray</tt> class represents a suffix array of a string of
 *  length <em>N</em>.
...
public class SuffixArray {
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.SuffixArray</tt> data type.
     */
    public static void main(String[] args) {
        String s = StdIn.readAll().replaceAll("\\s+", " ").trim();
        SuffixArray suffix = new SuffixArray(s);

        // com.akieus.algos.coursera.lib.StdOut.println("rank(" + args[0] + ") = " + suffix.rank(args[0]));
