 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.StdRandom.java
 *  Execution:    java com.akieus.algos.coursera.lib.StdRandom
 ...
 *
 *
 *  %  java com.akieus.algos.coursera.lib.StdRandom 5
 *  seed = 1316600602069
 ...
 *
 *  % java com.akieus.algos.coursera.lib.StdRandom 5 1316600616575
 *  seed = 1316600616575
 *  96 60.17070  true 8.72821  0 
 *  79 32.01607  true 8.58159  0 
 *  81 59.49065  true 9.10423  1 
...
public final class StdRandom {
    ...
    public static int geometric(double p) {
        if (!(p >= 0.0 && p <= 1.0))
            throw new IllegalArgumentException("Probability must be between 0.0 and 1.0");
        // using algorithm given by com.akieus.algos.coursera.lib.Knuth
