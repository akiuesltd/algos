 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.ClosestPair.java
 *  Execution:    java com.akieus.algos.coursera.lib.ClosestPair < input.txt
 *  Dependencies: com.akieus.algos.coursera.lib.Point2D.java
 *  
            ...
            for (int j = i+1; (j < M) && (aux[j].y() - aux[i].y() < delta); j++) {
                ...
                if (distance < delta) {
                    ...
                    if (distance < bestDistance) {
                        ...
                        best1 = aux[i];
                        best2 = aux[j];
                        // com.akieus.algos.coursera.lib.StdOut.println("better distance = " + delta + " from " + best1 + " to " + best2);
                    }
                }
            }
        }
