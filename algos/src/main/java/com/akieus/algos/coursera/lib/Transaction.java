 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.Transaction.java
 *  Execution:    java com.akieus.algos.coursera.lib.Transaction
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.Transaction</tt> class is an immutable data type to encapsulate a
...
public class Transaction implements Comparable<Transaction> {
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.Transaction</tt> data type.
     */
    public static void main(String[] args) {
        Transaction[] a = new Transaction[4];
        a[0] = new Transaction("Turing   6/17/1990  644.08");
        a[1] = new Transaction("Tarjan   3/26/2002 4121.85");
        a[2] = new Transaction("com.akieus.algos.coursera.lib.Knuth    6/14/1999  288.34");
