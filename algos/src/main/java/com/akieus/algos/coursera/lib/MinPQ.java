 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.MinPQ.java
 *  Execution:    java com.akieus.algos.coursera.lib.MinPQ < input.txt
 *  Dependencies: com.akieus.algos.coursera.lib.StdIn.java com.akieus.algos.coursera.lib.StdOut.java
 *  
 *  Generic min priority queue implementation with a binary heap.
 *  Can be used with a comparator instead of the natural order.
 *
 *  % java com.akieus.algos.coursera.lib.MinPQ < tinyPQ.txt
 *  E A E (6 left on pq)
 *
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.MinPQ</tt> class represents a priority queue of generic keys.
...
public class MinPQ<Key> implements Iterable<Key> {
    ...
    ***************************************************************************/
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.MinPQ</tt> data type.
     */
