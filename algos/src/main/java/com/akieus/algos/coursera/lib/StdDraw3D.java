 ...
 * com.akieus.algos.coursera.lib.StdDraw3D.java
 * Hayk Martirosyan
 ******************************************************************************
 * 3D Drawing Library
 *
 * Standard com.akieus.algos.coursera.lib.Draw 3D is a Java library with the express goal of making it
 ...
 * Standard com.akieus.algos.coursera.lib.Draw 3D is a Java library with the express goal of making it
 * simple to create three-dimensional models, simulations, and games.
 * Here is a <a href = "http://introcs.cs.princeton.edu/java/stddraw3d">com.akieus.algos.coursera.lib.StdDraw3D tutorial</a>
 * and the
 * <a href = "http://introcs.cs.princeton.edu/java/stddraw3d/stddraw3d-manual.html">com.akieus.algos.coursera.lib.StdDraw3D reference manual</a>.
 *
...
KeyListener, ActionListener, ChangeListener, ComponentListener, WindowFocusListener
{
    ...
    private static void initialize () {
        ...
        frame.setTitle("Standard com.akieus.algos.coursera.lib.Draw 3D");
...
/*                 while (!showedOnce) {
            ...
            //    catch (InterruptedException e) { System.out.println("Error sleeping"); }
            //}
            //com.akieus.algos.coursera.lib.StdOut.println("showed once is false, rendered once");
            showedOnce = false;
            //renderedOnce = true;
    ...
    private static JMenuBar createMenuBar () {
        ...
        JLabel graphicsLabel = new JLabel("Polygon com.akieus.algos.coursera.lib.Count");
     ...
     * -------------------------------------- <br>
     * com.akieus.algos.coursera.lib.StdDraw3D.ORBIT_MODE: <br>
     ...
     * -------------------------------------- <br>
     * com.akieus.algos.coursera.lib.StdDraw3D.FPS_MODE: <br>
     ...
     * Mouse       - Look <br>
     * -------------------------------------- <br>
     * com.akieus.algos.coursera.lib.StdDraw3D.AIRPLANE_MODE: <br>
     ...
     * Mouse       - Look <br>
     * -------------------------------------- <br>
     * com.akieus.algos.coursera.lib.StdDraw3D.LOOK_MODE: <br>
     * No movement, but uses mouse to look around. <br>
     *  <br>
     * Mouse - Look <br>
     * -------------------------------------- <br>
     * com.akieus.algos.coursera.lib.StdDraw3D.FIXED_MODE: <br>
     ...
     * default field of view. com.akieus.algos.coursera.lib.In this mode, closer objects appear
     ...
     * given field of view. com.akieus.algos.coursera.lib.In this mode, closer objects appear
     ...
     * com.akieus.algos.coursera.lib.In this mode, parallel lines remain parallel after
    ...
    private static void render3D () {
        ...
        //com.akieus.algos.coursera.lib.StdOut.println("showed once = true");
    }
    /* ***************************************************************
    ...
    /**
     * com.akieus.algos.coursera.lib.Draw picture (gif, jpg, or png) centered on (x, y), rescaled to w-by-h.
     */
    ...
    /**
     * com.akieus.algos.coursera.lib.Draw picture (gif, jpg, or png) centered on (x, y), rotated
    ...
    public static void saveScene3D (String filename) {
        ...
        try {
            SceneGraphFileWriter writer = new SceneGraphFileWriter(file, universe, false, "3D scene saved from com.akieus.algos.coursera.lib.StdDraw3D.", null);
    ...
    */
    ...
    /**
    * When you create a light in com.akieus.algos.coursera.lib.StdDraw3D, it returns a Light object. Light
    ...
    */
    ...
    public static class Vector3D { 
        ...
        */
         ...
         * 
         * @param that com.akieus.algos.coursera.lib.Vector to dot with
         ...
         * 
         * @param that com.akieus.algos.coursera.lib.Vector to compute distance between
         ...
         * 
         * @param that com.akieus.algos.coursera.lib.Vector to compute sum with
         ...
         * 
         * @param that com.akieus.algos.coursera.lib.Vector to compute difference with
        ...
        /**
         * Draws this vector as a point from the origin to com.akieus.algos.coursera.lib.StdDraw3D.
         */
        public void draw () {
        ...
        public void drawLine (Vector3D origin) {
            ...
            com.akieus.algos.coursera.lib.StdDraw3D.line(origin.x, origin.y, origin.z, end.x, end.y, end.z);
        } 
        */
    }
    ...
    public static void main (String[] args) {
        ...
        StdDraw3D.setPenColor(StdDraw3D.WHITE);
        StdDraw3D.overlayText(0, 0.91, "Standard com.akieus.algos.coursera.lib.Draw 3D - Test Program");
        ...
        StdDraw3D.Shape text = StdDraw3D.text3D(0, 0, 0, "com.akieus.algos.coursera.lib.StdDraw3D");
        text.scale(3.5);
        text.move(-0.7, -0.1, 0);
