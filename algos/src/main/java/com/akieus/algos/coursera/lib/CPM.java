 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.CPM.java
 *  Execution:    java com.akieus.algos.coursera.lib.CPM < input.txt
 *  Dependencies: com.akieus.algos.coursera.lib.EdgeWeightedDigraph.java AcyclicDigraphLP.java com.akieus.algos.coursera.lib.StdOut.java
 *  Data files:   http://algs4.cs.princeton.edu/44sp/jobsPC.txt
 *
 *  Critical path method.
 *
 *  % java com.akieus.algos.coursera.lib.CPM < jobsPC.txt
 *   job   start  finish
 *  --------------------
 *     0     0.0    41.0
 *     1    41.0    92.0
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.CPM</tt> class provides a client that solves the
