...
/******************************************************************************
 *  Compilation:  javac com.akieus.algos.coursera.lib.FarthestPair.java
 *  Execution:    java com.akieus.algos.coursera.lib.FarthestPair < input.txt
 *  Dependencies: com.akieus.algos.coursera.lib.GrahamScan.java com.akieus.algos.coursera.lib.Point2D.java
 *  
...
public class FarthestPair {
    ...
    public FarthestPair(Point2D[] points) {
        ...
        int j = k;
        for (int i = 1; i <= k; i++) {
            // com.akieus.algos.coursera.lib.StdOut.println("hull[i] + " and " + hull[j] + " are antipodal");
