 ...
 * <p/>
 * com.akieus.algos.coursera.lib.In <tt>Fenwick Tree</tt> structure We arrange the array in an smart way to perform efficient <em>range queries and updates</em>.
 * The key point is this: com.akieus.algos.coursera.lib.In a fenwick array, each position "responsible" for storing cumulative data of N previous positions (N could be 1)
 * For example:
...
public class FenwickTree {
    ...
    int[] array; // 1-indexed array, com.akieus.algos.coursera.lib.In this array We save cumulative information to perform efficient range queries and updates
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if ((!line[0].equals("set") && !line[0].equals("init")) && ft == null) {
                StdOut.println("com.akieus.algos.coursera.lib.FenwickTree not initialized");
                continue;
            }
