...
/******************************************************************************
 *  Compilation:  javac com.akieus.algos.coursera.lib.SparseVector.java
 *  Execution:    java com.akieus.algos.coursera.lib.SparseVector
...
public class SparseVector {
    ...
    public double dot(SparseVector that) {
        if (this.N != that.N) throw new IllegalArgumentException("com.akieus.algos.coursera.lib.Vector lengths disagree");
        double sum = 0.0;
