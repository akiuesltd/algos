...
/**
 * The <tt>com.akieus.algos.coursera.lib.SegmentTree</tt> class is an structure for efficient search of cummulative data.
 ...
 * st.update(0,3, 1)
 * com.akieus.algos.coursera.lib.In the above case only the node that represents the range [0,3] will be updated (and not their children) so in this case
