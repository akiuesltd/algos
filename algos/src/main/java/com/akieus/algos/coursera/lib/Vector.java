 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.Vector.java
 *  Execution:    java com.akieus.algos.coursera.lib.Vector
 *  Dependencies: com.akieus.algos.coursera.lib.StdOut.java
 *
 *  Implementation of a vector of real numbers.
 *
 *  This class is implemented to be immutable: once the client program
 *  initialize a com.akieus.algos.coursera.lib.Vector, it cannot change any of its fields
 *  (N or data[i]) either directly or indirectly. Immutability is a
 *  very desirable feature of a data type.
 *
 *  % java com.akieus.algos.coursera.lib.Vector
 *     x     = [ 1.0 2.0 3.0 4.0 ]
 *     y     = [ 5.0 2.0 4.0 1.0 ]
 *     z     = [ 6.0 4.0 7.0 5.0 ]
 ...
 * 
 *
 *  Note that com.akieus.algos.coursera.lib.Vector is also the name of an unrelated Java library class.
 *
 ******************************************************************************/

/**
 *  The <tt>com.akieus.algos.coursera.lib.Vector</tt> class represents a <em>d</em>-dimensional mathematical vector.
...
public class Vector { 
     ...
     * arugments such as com.akieus.algos.coursera.lib.Vector x = new com.akieus.algos.coursera.lib.Vector(1.0, 2.0, 3.0, 4.0).
