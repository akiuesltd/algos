 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.BST.java
 *  Execution:    java com.akieus.algos.coursera.lib.BST
 *  Dependencies: com.akieus.algos.coursera.lib.StdIn.java com.akieus.algos.coursera.lib.StdOut.java com.akieus.algos.coursera.lib.Queue.java
 ...
 *  
 *  % java com.akieus.algos.coursera.lib.BST < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.BST</tt> class represents an ordered symbol table of generic
 *  key-value pairs.
...
public class BST<Key extends Comparable<Key>, Value> {
    private Node root;             // root of com.akieus.algos.coursera.lib.BST
    ...
    // return number of key-value pairs in com.akieus.algos.coursera.lib.BST rooted at x
    ...
    /**
     * Returns the height of the com.akieus.algos.coursera.lib.BST (for debugging).
     * @return the height of the com.akieus.algos.coursera.lib.BST (a 1-node tree has height 0)
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Returns the keys in the com.akieus.algos.coursera.lib.BST in level order (for debugging).
     * @return the keys in the com.akieus.algos.coursera.lib.BST in level order traversal,
     *    as an Iterable
     */
  ...
  /*************************************************************************
    *  Check integrity of com.akieus.algos.coursera.lib.BST data structure.
    ***************************************************************************/
    ...
    // is the tree rooted at x a com.akieus.algos.coursera.lib.BST with all keys strictly between min and max
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.BST</tt> data type.
     */
