 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.Bipartite.java
 *  Execution:    java  com.akieus.algos.coursera.lib.Bipartite V E F
 *  Dependencies: com.akieus.algos.coursera.lib.Graph.java
 *
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.Bipartite</tt> class represents a data type for
...
public class Bipartite {
    ...
    public boolean color(int v) {
        if (!isBipartite)
            throw new UnsupportedOperationException("com.akieus.algos.coursera.lib.Graph is not bipartite");
        return color[v];
    }
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.Bipartite</tt> data type.
     */
    public static void main(String[] args) {
        ...
        if (b.isBipartite()) {
            StdOut.println("com.akieus.algos.coursera.lib.Graph is bipartite");
            for (int v = 0; v < G.V(); v++) {
                StdOut.println(v + ": " + b.color(v));
            }
        }
        else {
            StdOut.print("com.akieus.algos.coursera.lib.Graph has an odd-length cycle: ");
