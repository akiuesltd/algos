 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.BinaryStdIn.java
 *  Execution:    java com.akieus.algos.coursera.lib.BinaryStdIn < input > output
 *  Dependencies: none             
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java com.akieus.algos.coursera.lib.BinaryStdIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>com.akieus.algos.coursera.lib.BinaryStdIn</tt> with calls
 *  to <tt>com.akieus.algos.coursera.lib.StdIn</tt> or <tt>System.in</tt>;
   ...
   /**
    ...
    public static void close() {
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("Could not close com.akieus.algos.coursera.lib.BinaryStdIn");
        }
    }
