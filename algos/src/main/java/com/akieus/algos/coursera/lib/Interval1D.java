 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.Interval1D.java
 *  Execution:    java com.akieus.algos.coursera.lib.Interval1D
...
/**
 *  The <tt>com.akieus.algos.coursera.lib.Interval1D</tt> class represents a one-dimensional interval.
 *  The interval is <em>closed</em>&mdash;it contains both endpoints.
 *  Intervals are immutable: their values cannot be changed after they are created.
 *  The class <code>com.akieus.algos.coursera.lib.Interval1D</code> includes methods for checking whether
...
public class Interval1D {
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.Interval1D</tt> data type.
     */
