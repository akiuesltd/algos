 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.Out.java
 *  Execution:    java com.akieus.algos.coursera.lib.Out
 *  Dependencies: none
 *
...
public class Out {
    ...
    // assume language = English, country = US for consistency with com.akieus.algos.coursera.lib.In
