 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.BinaryOut.java
 *  Execution:    java com.akieus.algos.coursera.lib.BinaryOut
 *  Dependencies: none
 *
 ...
 *  <p>
 *  The client should not intermixing calls to <tt>com.akieus.algos.coursera.lib.BinaryOut</tt> with calls
 *  to <tt>com.akieus.algos.coursera.lib.Out</tt>; otherwise unexpected behavior will result.
 *
...
public final class BinaryOut {
   ...
   /**
    ...
    public void write(int x, int r) {
        ...
        if (x >= (1 << r))   throw new RuntimeException("Illegal " + r + "-bit char = " + x);
        for (int i = 0; i < r; i++) {
