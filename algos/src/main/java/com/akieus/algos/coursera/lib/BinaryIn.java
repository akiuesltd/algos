 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.BinaryIn.java
 *  Execution:    java com.akieus.algos.coursera.lib.BinaryIn input output
 *  Dependencies: none             
 *  
 *  This library is for reading binary data from an input stream.
 *
 *  % java com.akieus.algos.coursera.lib.BinaryIn http://introcs.cs.princeton.edu/cover.jpg output.jpg
 *
 ******************************************************************************/
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>com.akieus.algos.coursera.lib.BinaryIn</tt> with calls
 *  to <tt>com.akieus.algos.coursera.lib.In</tt>; otherwise unexpected behavior will result.
 *
