...
/**
 *  The com.akieus.algos.coursera.lib.BinomialMinPQ class represents a priority queue of generic keys.
...
public class BinomialMinPQ<Key> implements Iterable<Key> {
	 ...
	 * Worst case is O(log(n))
	 * @param heap a Binomial com.akieus.algos.coursera.lib.Heap to be merged with the current heap
	...
	public BinomialMinPQ<Key> union(BinomialMinPQ<Key> heap) {
		if (heap == null) throw new IllegalArgumentException("Cannot merge a Binomial com.akieus.algos.coursera.lib.Heap with null");
