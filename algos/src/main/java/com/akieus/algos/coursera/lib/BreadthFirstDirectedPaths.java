 ...
 *  Compilation:  javac com.akieus.algos.coursera.lib.BreadthFirstDirectedPaths.java
 *  Execution:    java com.akieus.algos.coursera.lib.BreadthFirstDirectedPaths V E
 *  Dependencies: com.akieus.algos.coursera.lib.Digraph.java com.akieus.algos.coursera.lib.Queue.java com.akieus.algos.coursera.lib.Stack.java
 *
 *  Run breadth first search on a digraph.
 *  Runs in O(E + V) time.
 *
 *  % java com.akieus.algos.coursera.lib.BreadthFirstDirectedPaths tinyDG.txt 3
 *  3 to 0 (2):  3->2->0
 *  3 to 1 (3):  3->2->0->1
 *  3 to 2 (1):  3->2
 *  3 to 3 (0):  3
...
public class BreadthFirstDirectedPaths {
    ...
    /**
     * Unit tests the <tt>com.akieus.algos.coursera.lib.BreadthFirstDirectedPaths</tt> data type.
     */
    public static void main(String[] args) {
        In in = new In(args[0]);
        Digraph G = new Digraph(in);
        // com.akieus.algos.coursera.lib.StdOut.println(G);
