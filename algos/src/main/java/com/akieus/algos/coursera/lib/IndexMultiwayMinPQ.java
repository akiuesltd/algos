...
/**
 *  The com.akieus.algos.coursera.lib.IndexMultiwayMinPQ class represents an indexed priority queue of generic keys.
...
public class IndexMultiwayMinPQ<Key> implements Iterable<Integer> {
	...
	private int[] pq;					//com.akieus.algos.coursera.lib.Multiway heap
