...
/******************************************************************************
 *  Compilation:  javac com.akieus.algos.coursera.lib.Alphabet.java
 *  Execution:    java com.akieus.algos.coursera.lib.Alphabet
...
public class Alphabet {
    ...
    // Create a new com.akieus.algos.coursera.lib.Alphabet from sequence of characters in string.
    ...
    // Create a new com.akieus.algos.coursera.lib.Alphabet of Unicode chars 0 to R-1
    ...
    // Create a new com.akieus.algos.coursera.lib.Alphabet of Unicode chars 0 to 255 (extended ASCII)
    public Alphabet() {
        this(256);
    }
    ...
    public char toChar(int index) {
        if (index < 0 || index >= R) {
            throw new IndexOutOfBoundsException("com.akieus.algos.coursera.lib.Alphabet index out of bounds");
        }
